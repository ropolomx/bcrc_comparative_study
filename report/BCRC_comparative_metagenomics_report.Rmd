...
The metagenomic sequencing reads were analyzed with a custom Galaxy workflow that runs
the microbiome and resistome analysis in parallel. The microbiome work is based on the 
the AMRPlusPlus pipeline [@lakin_megares_2017] in the computer cluster of the National 
...
![](../graphs/Microbiome/TypeOverall/Microbiome_alphadiversity_by_Type.png)
