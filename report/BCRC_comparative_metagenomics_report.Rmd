...
The samples were run with a custom Galaxy workflow based on the AMRPlusPlus pipeline 
[@lakin_megares_2017] in the computer cluster of the National Microbiology Laboratory 
(Public Health Agency of Canada).

The following steps were performed in the bioinformatics workflow for the 
...
1. Sample type (fecal composite, catch basin, soil, and sewage treatment)
...
4. Geographical location (Acme, Calgary, Iron Springs, Medicine Hat, Nanton, 
Vegreville)
5. Sewage treatment locations (Calgary vs. Medicine Hat)
6. Fecal composite locations (Acme, Iron Springs, Nanton, Vegreville)
...
rarefied data, while species richness (total number of species) was calculated 
...
![](../graphs/AMR/TypeOverall/Class_Type_Heatmap.png)
...
![](/home/rodrigo/amr/bcrc-analysis_steven/graphs/Microbiome/TypeOverall/Microbiome_alphadiversity_by_Type.png)
...
![](/home/rodrigo/amr/bcrc-analysis_steven/graphs/Microbiome/TypeOverall/Microbiome_rarefied_richness_by_Type.png)
